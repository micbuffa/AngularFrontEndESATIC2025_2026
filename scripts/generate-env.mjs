...
if (fs.existsSync(envPath)) {
  ...
  console.warn('[generate-env] Aucun .env trouvé, utilisation des valeurs par défaut.');
}

const assignmentsApiUrl =
  process.env.ASSIGNMENTS_API_URL ||
  process.env.NG_APP_ASSIGNMENTS_API_URL ||
...
// Source: .env (local). Ne pas éditer à la main.
